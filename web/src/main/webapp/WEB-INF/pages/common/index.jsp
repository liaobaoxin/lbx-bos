        ...
        <form id="editPasswordForm">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password" required="true"
                                   data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" required="true" data-options="validType:'length[4,6]'"
